...
<div class="bilingual-subtitle">
    Digital Impact Analysis of Abu Obeida / تحليل الأثر الرقمي لأبو عبيدة
</div>
""", unsafe_allow_html=True)
...
<div class="quranic-verse">
    <div class="quranic-text-ar">
        مِّنَ الْمُؤْمِنِينَ رِجَالٌ صَدَقُوا مَا عَاهَدُوا اللَّهَ عَلَيْهِ ۖ<br>
        فَمِنْهُم مَّن قَضَىٰ نَحْبَهُ وَمِنْهُم مَّن يَنتَظِرُ ۖ وَمَا بَدَّلُوا تَبْدِيلًا
    </div>
    <div class="quranic-text-en">
        "Among the believers are men who have been true to what they pledged to Allah.<br>
        Some of them have fulfilled their vow, and some are still waiting, and they have not changed in the least."
        <br><strong style="color: #007A3D;">- Surah Al-Ahzab (33:23)</strong>
    </div>
    <div class="duaa-box">
        <div class="duaa-text">
            May Allah Almighty accept him and all our martyrs in the highest gardens of Jannah.
            <div class="duaa-text-ar">اللهم تقبله وتقبل شهداءنا في عليين ✨</div>
        </div>
    </div>
</div>
""", unsafe_allow_html=True)
...
# Arabic Introduction
st.markdown("""
<div style="max-width: 900px; margin: 30px auto; padding: 30px; background: linear-gradient(135deg, #1a1a1a 0%, #0a0a0a 100%); border-radius: 15px; border-right: 5px solid #007A3D; box-shadow: 0 6px 20px rgba(0, 122, 61, 0.3);" dir="rtl">
    <h3 style="color: #007A3D; font-size: 2rem; font-weight: 800; margin-bottom: 20px; text-align: center;">
        صوت الحق في زمن الضجيج
    </h3>
    <p style="color: #E0E0E0; font-size: 1.25rem; line-height: 2.2; text-align: justify; padding: 0 20px;">
        في عصر تتدفق فيه المعلومات بسرعة الضوء، برز صوت "الملثم" ليخترق حجب الصمت والتزييف. لم يعد أبو عبيدة مجرد ناطق عسكري، بل تحول بكلماته المتزنة ويقينه الثابت إلى أيقونة عالمية للحقيقة. من تحت ركام غزة، وصل صوته إلى كل قارات العالم، متجاوزًا الحدود واللغات، ليعيد للأمة تعريف معاني العزة واليقين. هذا التحليل الرقمي ليس مجرد أرقام، بل هو توثيق لكيفية انتصار "الرواية الصادقة" على أعتى آلات الدعاية العالمية، وكيف يمكن لصدق الكلمة أن يحيي القلوب.
    </p>
</div>
""", unsafe_allow_html=True)
